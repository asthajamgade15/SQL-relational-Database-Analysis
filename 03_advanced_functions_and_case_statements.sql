...
-- 1. User-defined function to insert "Chicken" into "Quick Bites"
--    e.g. "Quick Bites" -> "Quick Chicken Bites"
...
BEGIN
    ...
    SET @Result = STUFF(
        @RestaurantType,
        CHARINDEX('Quick Bites', @RestaurantType),
        LEN('Quick Bites'),
        'Chicken Bites'
    )
    RETURN @Result
...
--    for the restaurant with the maximum number of ratings
SELECT TOP 1
    RestaurantName,
    CuisinesType,
